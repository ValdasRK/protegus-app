...
return [
    ...
    'reactions'    => [
        'labels'         => [
            ...
            'notification_sound_default' => 'Podrazumevano za uređaj',
            'notification_sound_custom'  => 'Custom',
            'notification_sound_info'    => 'Zvuk obaveštenja: ',
        ],
        'redirects'      => [
            'event'  => 'Strana događaja',
            'sensor' => 'Strana za senzore',
        ],
        'noReaction'     => 'Događaj nema reakcija',
        'translationKey' => 'Prevodilački ključevi',
    ],
];
